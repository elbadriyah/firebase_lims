...
import 'package:flutter_crud_firebase/app/modules/add_barang/controllers/add_barang_controller.dart';
...
class AddTbarangView extends GetView<AddBarangController> {
  const AddTbarangView({Key? key}) : super(key: key);
  @override
